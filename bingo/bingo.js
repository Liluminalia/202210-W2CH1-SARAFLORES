const bingo = () => {
    ...
    let bingo = () => {
        ...
        const Random = () => {
            ...
            listOfRandomNumbers = listOfRandomNumbers.sort(function () {
        ...
        const randomBingoCard = () => {
            ...
            numbersOfBingoCard = numbersOfBingoCard.sort(function () {
                return Math.random() - 0.5;
            });
        ...
        let lines = (sum1, sum2, sum3) => {
            sum1 =
                numbersOfBingoCard[0] +
                numbersOfBingoCard[1] +
                numbersOfBingoCard[2] +
                numbersOfBingoCard[3] +
                numbersOfBingoCard[4];
            sum2 =
                numbersOfBingoCard[5] +
                numbersOfBingoCard[6] +
                numbersOfBingoCard[7] +
                numbersOfBingoCard[8] +
                numbersOfBingoCard[9];
            sum3 =
                numbersOfBingoCard[10] +
                numbersOfBingoCard[11] +
                numbersOfBingoCard[12] +
                numbersOfBingoCard[13] +
                numbersOfBingoCard[14];
            if (sum1 === 0) {
